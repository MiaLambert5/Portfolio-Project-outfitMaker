...
The design I have chosen to implement is the outfitMaker concept that I was originally
planning on tryin to implement. My reasoning for this is that I feel it is something
I will enjoy working on as well as it will not be time consuming as this is a limited time
project to work on amoung other things. I also believe that I could use this as a basis
to possibly create something bigger, or further adapt in the future. I mention in
my code that I changed some of my kernel methods to be more "getter" methods and I also
made one kernal implementation for adding or removing a clothing item.
